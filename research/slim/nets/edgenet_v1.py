...
# EDGENETV1_CONV_DEFS specifies the MobileNet body
EDGENETV1_CONV_DEFS = [
...
def edgenet_v1(inputs,
  ...
  with tf.compat.v1.variable_scope(
      scope, 'EdgenetV1', [inputs], reuse=reuse) as scope:
...
edgenet_v1.default_image_size = 320
...
def edgenet_v1_arg_scope(
  ...
  """Defines the default EdgenetV1 arg scope.
