...
def edgenet_v2_base(inputs,
  ...
  if use_explicit_padding:
    padding = 'VALID'
  with tf.compat.v1.variable_scope(scope, 'EdgenetV1', [inputs]):
...
def edgenet_v2(inputs,
  ...
  with tf.compat.v1.variable_scope(
      scope, 'EdgenetV2', [inputs], reuse=reuse) as scope:
    with slim.arg_scope([slim.batch_norm, slim.dropout],
                        is_training=is_training):
      net, end_points = edgenet_v2_base(inputs, scope=scope,
                                          min_depth=min_depth,
...
edgenet_v2.default_image_size = 320
...
edgenet_v2_075 = wrapped_partial(edgenet_v2, depth_multiplier=0.75)
edgenet_v2_050 = wrapped_partial(edgenet_v2, depth_multiplier=0.50)
edgenet_v2_025 = wrapped_partial(edgenet_v2, depth_multiplier=0.25)
