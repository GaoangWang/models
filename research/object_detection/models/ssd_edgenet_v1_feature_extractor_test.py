...
from object_detection.models import ssd_edgenet_v1_feature_extractor
...
class SsdEdgenetV1FeatureExtractorTest(
  ...
  def _create_feature_extractor(self,
    ...
    if use_keras:
      ...
      return ssd_edgenet_v1_feature_extractor.SSDEdgeNetV1FeatureExtractor(
          is_training,
          depth_multiplier,
          min_depth,
          pad_to_multiple,
